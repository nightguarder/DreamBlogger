                  ...
                  this.group &&
                    ...
                    window.$hsAccordionCollection
                      .find(function (e) {
                        return (
                          e.element.el ===
                          t.group.querySelector(".hs-accordion.active")
                        );
                      })
                      .element.hide();
            ...
            u = (function (t) {
              function e(e, n, o) {
                ...
                return (
                  ...
                  (i.eventMode = (0, s.getClassProperty)(
                    i.el,
                    "--trigger",
                    "click"
                  )),
                  (i.closeMode = (0, s.getClassProperty)(
                    i.el,
                    "--auto-close",
                    "true"
                  )),
              ...
              return (
                ...
                (e.prototype.resizeHandler = function () {
                  this.eventMode = (0, s.getClassProperty)(
                    this.el,
                    "--trigger",
                    "click"
                  );
              ...
              function e(e, n, o) {
                ...
                return (
                  ...
                  (a.isClosePrev =
                    ...
                    i),
                  (a.backdropClasses =
                    null !== (l = null == d ? void 0 : d.backdropClasses) &&
                    void 0 !== l
                      ? l
              ...
              return (
                ...
                (e.prototype.init = function () {
                  ...
                  this.createCollection(window.$hsOverlayCollection, this),
                    this.el.addEventListener("click", function () {
                      t.overlay.classList.contains(t.hiddenClass)
                        ? t.open()
                        : t.close();
                    }),
                ...
                (e.prototype.hideAuto = function () {
                  var t = this,
                    e = parseInt(
                      (0, s.getClassProperty)(this.overlay, "--auto-hide", "0")
                    );
                  e &&
                ...
                (e.prototype.open = function () {
                  ...
                  n && (document.body.style.overflow = "hidden"),
                    ...
                    setTimeout(function () {
                      if (t.overlay.classList.contains(t.hiddenClass))
                        return !1;
                ...
                (e.accessibility = function (t) {
                  ...
                  if (
                    a &&
                    "false" === i.element.isTabAccessibilityLimited &&
                    "Tab" === t.code
                  )
                    return !1;
                  a &&
                    l.length &&
                    "Tab" === t.code &&
                    (t.preventDefault(), this.onTab(i, l)),
                    a &&
                      "Escape" === t.code &&
              ...
              return (
                ...
                (e.prototype.update = function (t, e) {
                  var n = parseInt(
                    ...
                    o =
                      parseInt(
                        (0, r.getClassProperty)(e, "--scrollspy-offset")
                      ) || n,
                    i =
                      t.target === document
                        ? 0
                ...
                (e.prototype.scrollTo = function (t) {
                  var e = t.getAttribute("href"),
                    ...
                    i =
                      parseInt(
                        (0, r.getClassProperty)(n, "--scrollspy-offset")
                      ) || o,
                    s =
              ...
              return (
                ...
                (e.prototype.itemTemplate = function (t) {
                  ...
                  this.dropdownItemClasses &&
                    (0, a.classToClassList)(this.dropdownItemClasses, r);
                  var s = r.querySelector("[data-title]");
                  s
                    ? s.append(
                        (0, a.htmlToElement)("<span>".concat(n, "</span>"))
                      )
                    : r.append(
                        (0, a.htmlToElement)("<span>".concat(n, "</span>"))
                      );
                  ...
                  if (l)
                    l.append(
                      (0, a.htmlToElement)("<span>".concat(o, "</span>"))
                    );
                  else if (!i) {
            ...
            u = (function (t) {
              function e(e, n) {
                ...
                return (
                  ...
                  (i.tagsClasses =
                    (null == a ? void 0 : a.tagsClasses) || null),
                  (i.tagsItemTemplate =
              ...
              return (
                ...
                (e.prototype.buildToggle = function () {
                  ...
                  (this.toggleTextWrapper = document.createElement("span")),
                    ...
                    this.toggleClasses &&
                      (0, l.classToClassList)(this.toggleClasses, this.toggle),
                ...
                (e.prototype.buildTags = function () {
                  (this.tags = document.createElement("div")),
                    ...
                    this.tagsClasses &&
                      (0, l.classToClassList)(this.tagsClasses, this.tags),
                    this.buildTagsInput(),
                    this.buildTagsItems(),
                    this.setTagsItems(),
                ...
                (e.prototype.buildTagsItem = function (t) {
                  ...
                  if (
                    (this.tagsItemClasses &&
                      (0, l.classToClassList)(this.tagsItemClasses, d),
                ...
                (e.prototype.buildDropdown = function () {
                  var t = this;
                  (this.dropdown = (0, l.htmlToElement)(
                ...
                (e.prototype.buildSearch = function () {
                  ...
                  (this.searchWrapper = (0, l.htmlToElement)(
                    ...
                    (this.search = (0, l.htmlToElement)(
                      '<input type="text" />'
                    )),
                    (this.search.placeholder = this.searchPlaceholder),
                    this.searchClasses &&
                      (0, l.classToClassList)(this.searchClasses, this.search),
                ...
                (e.prototype.buildOption = function (t, e, n, o) {
                  ...
                  if (
                    ...
                    this.optionTemplate &&
                      ((r = (0, l.htmlToElement)(this.optionTemplate)),
                      s.append(r)),
                    r
                    ...
                    if (n.icon) {
                      ...
                      if ((a.classList.add("mw-full"), r))
                        r.querySelector("[data-icon]").append(a);
                      else {
                        var c = (0, l.htmlToElement)("<div></div>");
                        this.iconClasses &&
                          (0, l.classToClassList)(this.iconClasses, c),
                          c.append(a),
                          s.append(c);
                      }
                    }
                  ...
                  r &&
                    ...
                    this.optionClasses &&
                      (0, l.classToClassList)(this.optionClasses, s),
                ...
                (e.prototype.searchOptions = function (t) {
                  this.searchNoResult &&
                    ...
                    (this.searchNoResult = (0, l.htmlToElement)(
                      "<span></span>"
                    )),
                ...
                (e.accessibility = function (t) {
                  ...
                  if (
                    e &&
                    c.SELECT_ACCESSIBILITY_KEY_SET.includes(t.code) &&
                    !t.metaKey
                  )
                    switch (
                      (console.log(e), console.log("Key code:", t.code), t.code)
                    ) {
                      case "Escape":
                ...
                (e.prototype.buildStrips = function () {
                  if (((this.el.innerHTML = ""), this.stripClasses))
                    for (var t = 0; t < this.availableChecks.length; t++) {
                      ...
                      (0, s.classToClassList)(this.stripClasses, e),
                        this.el.append(e);
                    }
                }),
            ...
            l = (function (t) {
              function e(e, n) {
                ...
                return (
                  ...
                  (o.eventType = (0, s.isFormElement)(o.el)
                    ? "change"
                    : "click"),
                  (o.isMultiple =
                    o.target.length > 1 &&
              ...
              function e(e, n, o) {
                ...
                return (
                  i.el &&
                    ...
                    (i.eventMode =
                      (0, a.getClassProperty)(i.el, "--trigger") || "hover"),
                    (i.preventPopper = (0, a.getClassProperty)(
                      i.el,
                      "--prevent-popper",
                      "false"
                    )),
                    (i.placement = (0, a.getClassProperty)(
                      i.el,
                      "--placement"
                    )),
